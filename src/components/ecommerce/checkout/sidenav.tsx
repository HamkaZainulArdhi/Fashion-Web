    ...
    <button className="w-full bg-black text-white py-3 rounded hover:bg-gray-800 transition">
        ...
        <div className="space-y-4">
          <div className="flex items-center">
            <input 
              ...
              className="mr-2"
            />
            <label htmlFor="pay-money">Pay with Money</label>
          </div>
          ...
          <div className="flex items-center">
            <input 
              ...
              className="mr-2"
            />
            <label htmlFor="pay-exchange">Pay with Clothing Exchange</label>
          </div>
          
          {paymentMethod === "exchange" && (
            <div className="mt-4 border-t pt-4">
              <p className="text-sm mb-2">Upload a photo of the clothing item you want to exchange:</p>
      ...
      <div className="bg-primary text-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between">
            <span>Discount</span>
            <span className="text-green-900">-${discount.toFixed(2)}</span>
          </div>
        ...
        <button className="w-full bg-blue-600 text-white py-3 rounded mt-4 hover:bg-blue-500 transition">
          Apply
        </button>
      </div>
    </div>
