          ...
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              ...
              >
                ...
                <div className="absolute left-10 w-[10%] z-30 -bottom-px bg-gradient-to-r from-transparent via-sky-500 to-transparent h-px " />
                <div className="font-bold text-sky-500 relative z-30 text-base">
                  {item.name}
                </div>
                <div className="text-sky-900 text-xs">{item.designation}</div>
              </motion.div>
            )}
          </AnimatePresence>
          <Image
